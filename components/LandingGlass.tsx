...
export function LandingGlass() {
  ...
  useEffect(() => {
    ...
    const DEFAULT_A =
      "כשעוסק פטור חוצה את התקרה השנתית (כ-120,000 ₪ נכון ל-2025) עליו להירשם כעוסק מורשה. מומלץ לפנות לרשות המסים בהקדם ולהתחיל לגבות מע\"מ ולהגיש דוחות תקופתיים.";
    const DEFAULT_SRC = "מבוסס על מדריך רשות המסים 2025";
    const TEASER_A =
          ...
          <div className="wrap hero-grid">
            ...
            <div className="hero-demo-wrap">
              ...
              <p className="sr-only">
                ...
                פטור חוצה את התקרה השנתית (כ-120,000 ₪ נכון ל-2025) עליו להירשם
                כעוסק מורשה. מומלץ לפנות לרשות המסים בהקדם ולהתחיל לגבות מע&quot;מ
                ולהגיש דוחות תקופתיים. מבוסס על מדריך רשות המסים 2025.&quot;
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="wrap">
            ...
            <div className="chat-thread" id="chatThread">
              ...
              <article className="turn" data-role="assistant">
                ...
                <div className="msg assistant">
                  כשעוסק פטור חוצה את התקרה השנתית (כ-120,000 ₪ נכון ל-2025) עליו
                  להירשם כעוסק מורשה. מומלץ לפנות לרשות המסים בהקדם ולהתחיל לגבות
                  מע&quot;מ ולהגיש דוחות תקופתיים.
                  <div className="msg-sources">
                    <span className="source-tag">
                      <CheckCircleIcon />
                      מבוסס על מדריך רשות המסים 2025
                    </span>
                  </div>
                </div>
              </article>
